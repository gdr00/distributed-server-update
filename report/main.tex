...
(by default) written every \texttt{TombstoneTTL/4} whith a dedicated goroutine in
...
\texttt{InitNew} or \texttt{InitEmptyNode}, going through \texttt{Init()}
...
\texttt{TestWritePropagatesAcrossNodes} it injects a distinct
...
at unit level since the actor model serializes the writes anyway at system's.
